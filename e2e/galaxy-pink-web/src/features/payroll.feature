...
Feature: Payroll
  ...
  Scenario: Commission payroll type calculate correctly
    ...
    And I change price amount "45.7"
    Then I should see the total price "$45.70" visible

    When I click on the "Pay" button
    And I select the "Credit" payment type
    And I fill the last 4 digits of card number "1234"
    And I select the "VISA" on the menu
    Then I should see the payment history "VISA (1234)$47.07" visible
    ...
    And I should see the payroll type "Commission"
    And I should see the # of Work Days is 1
    And I should see the text "Technician Pay" visible
    And I should see the "Total Sale $45.70" on the single payroll
    And I should see the "Product Total Sale $0.00" on the single payroll
    And I should see the "Service Total Sale $45.70" on the single payroll
    And I should see the "Net Total Sale $42.70" on the single payroll
    And I should see the "Service Commission $25.62" on the single payroll
    And I should see the "Product Commission $0.00" on the single payroll
    And I should see the "Daily Maintenance Fee ($5.00)" on the single payroll
    And I should see the "Net Non-Cash Tip $0.00" on the single payroll
    And I should see the "Tax Withheld on Cash ($0.25)" on the single payroll
    And I should see the "Total Payout $20.37" on the single payroll
    And I should see the "Pay 1 $12.37" on the single payroll
    And I should see the "Pay 2 $8.00" on the single payroll

    Then I should see the header Daily Details on the single payroll
    And I should see the "Total Sales $45.70" of daily details
    And I should see the "Net Comm $25.62" of daily details
    And I should see the "NC Tip $0.00" of daily details
    And I should see the "Total Payout $25.62" of daily details
